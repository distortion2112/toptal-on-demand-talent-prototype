    ...
    return (
      <div style={{
        ...
        <div style={{
          ...
          borderRadius: 12, padding: '48px 52px',
    ...
    <div style={{ background: T.lightBg, minHeight: '100vh', fontFamily: sans }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          background: T.alert, color: T.white,
        ...
        <div style={{ textAlign: 'right' }}>
          <div style={{ fontFamily: mono, fontSize: 10, color: 'rgba(255,255,255,0.4)', letterSpacing: '0.06em', textTransform: 'uppercase', marginBottom: 2 }}>Time live</div>
          <div style={{ fontFamily: mono, fontSize: 16, fontWeight: 700, color: T.white, fontVariantNumeric: 'tabular-nums' }}>{elapsed}</div>
        </div>
        ...
        <div style={{
          ...
          <div style={{ fontFamily: mono, fontSize: 10, color: 'rgba(255,255,255,0.4)', letterSpacing: '0.06em', textTransform: 'uppercase', marginBottom: 4 }}>SLA remaining</div>
          <div style={{ fontFamily: mono, fontSize: 15, fontWeight: 700, color: slaColor, fontVariantNumeric: 'tabular-nums' }}>{sla.display}</div>
          <div style={{ marginTop: 4, height: 3, background: 'rgba(255,255,255,0.12)', borderRadius: 99, overflow: 'hidden' }}>
      ...
      <div style={{
        ...
        {/* ─── Left: participants + war room info ─── */}
        <div style={{
          ...
          <div>
            ...
            <div style={{
              background: T.amberSoft, border: `1px solid #F5D78E`,
        ...
        {/* ─── Center: timeline + resolution ─── */}
        <div style={{ overflowY: 'auto', padding: '22px 28px', display: 'flex', flexDirection: 'column', gap: 28 }}>

          {/* SME first-action card */}
          <div style={{
            background: T.navy, borderRadius: 10, padding: '18px 22px',
            border: `2px solid ${T.teal}`,
          }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 12 }}>
              <div style={{
                width: 32, height: 32, borderRadius: '50%',
                background: '#C7D9F0', display: 'grid', placeItems: 'center',
                fontFamily: sans, fontSize: 11, fontWeight: 700, color: T.navy,
                border: `2px solid ${T.teal}`,
              }}>PN</div>
              <div>
              ...
              {[
                ...
                <div key={i} style={{ display: 'flex', gap: 10, alignItems: 'flex-start' }}>
                  <div style={{
                    ...
                    background: T.teal, display: 'grid', placeItems: 'center', flexShrink: 0, marginTop: 1,
                  }}>
        ...
        {/* ─── Right: resources + metrics + resolve ─── */}
        <div style={{
          ...
          <div style={{
            ...
            <button
              onClick={() => navigate('/emergency/context-card')}
              style={{
                background: 'none', border: `1px solid ${T.line}`,
                borderRadius: 4, padding: '6px 12px',
                cursor: 'pointer', fontSize: 12, color: T.muted,
                fontFamily: sans, width: '100%',
              }}>← Review context card</button>
          </div>

          {/* Resolve CTA */}
          <div style={{ marginTop: 'auto' }}>
            <div style={{
              background: T.tealSoft, border: `1px solid ${T.tealInk}33`,
